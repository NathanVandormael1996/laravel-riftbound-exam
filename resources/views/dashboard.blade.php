            ...
            <div class="flex flex-col md:flex-row gap-8">
                ...
                <aside class="w-full md:w-80 shrink-0 space-y-8">
                    ...
                    <nav class="sentry-glass p-2 space-y-1">
                        <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg bg-sentry-purple/10 text-sentry-light border-l-2 border-sentry-purple transition-all">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="sentry-card p-8 border-sentry-pink/30 group">
                            <div class="space-y-4">
                                ...
                                @php $recentOrders = auth()->user()->orders()->latest()->take(3)->get(); @endphp

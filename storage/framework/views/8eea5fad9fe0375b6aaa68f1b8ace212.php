...
<div class="py-12">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mb-8 flex items-center justify-between">
            <a href="<?php echo e(route('orders.index')); ?>" wire:navigate class="text-xs sentry-label opacity-40 hover:opacity-100 transition-all flex items-center gap-2">
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
                Back to History
            </a>
            <div class="flex items-center gap-3">
                <span class="sentry-label opacity-40">Status:</span>
                <span class="sentry-badge border-sentry-purple text-sentry-purple"><?php echo e($order->status->value); ?></span>
            </div>
        </div>
                ...
                <div class="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div class="space-y-6">
                        <div>
                            ...
                            <p class="font-mono text-3xl font-bold text-white"><?php echo e($order->order_number); ?></p>
                            <p class="text-xs text-sentry-light opacity-50 mt-1">Processed on <?php echo e($order->created_at->format('F d, Y \a\t H:i')); ?></p>
                        </div>

                        <div class="grid grid-cols-2 gap-6">
                            <div>
                                <h3 class="sentry-label mb-2">Value</h3>
                                <p class="text-xl font-mono font-bold text-sentry-light">€<?php echo e(number_format($order->total_amount, 2)); ?></p>
                            </div>
                            <div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <div class="text-sm text-sentry-light leading-relaxed">
                                <p class="font-bold text-white"><?php echo e($order->shipping_name); ?></p>
                                <p class="opacity-70"><?php echo e($order->shipping_address); ?></p>
                            </div>
                        </div>
                        <div>
                            <h3 class="sentry-label mb-2">Communication</h3>
                            <p class="text-sm text-white"><?php echo e($order->billing_email); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="sentry-glass overflow-hidden">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="p-6 flex items-center justify-between gap-6 hover:bg-sentry-purple/5 transition-colors">
                            <div class="flex items-center gap-6">
                                ...
                                <div>
                                    <h4 class="font-bold text-white"><?php echo e($item->product_name_snapshot); ?></h4>
                                    <p class="text-[10px] sentry-label opacity-40 mt-1">Acquired Unit Price: €<?php echo e(number_format($item->price_snapshot, 2)); ?></p>
                                </div>
                            </div>
                            <div class="text-right">
                                <div class="text-xs text-sentry-light opacity-50 mb-1">x <?php echo e($item->quantity); ?></div>
                                <div class="font-mono font-bold text-white">€<?php echo e(number_format($item->subtotal, 2)); ?></div>
                            </div>
                        </div>
                ...
                <div class="p-8 bg-sentry-darker/50 flex justify-between items-end">
                    ...
                    <div class="text-right space-y-1">
                        ...
                        <div class="text-4xl font-mono font-bold text-sentry-light">€<?php echo e(number_format($order->total_amount, 2)); ?></div>
                    </div>
                </div>
            </div>
        </div>
    </div>
</div><?php /**PATH /srv/http/laravel-riftbound-exam/resources/views/livewire/pages/orders/show.blade.php ENDPATH**/ ?>
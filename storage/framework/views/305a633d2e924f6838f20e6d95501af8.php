        ...
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <aside class="w-full md:w-80 shrink-0 space-y-8">
                ...
                <nav class="sentry-glass p-2 space-y-1">
                    <a href="<?php echo e(route('dashboard')); ?>" wire:navigate class="flex items-center space-x-3 px-4 py-3 rounded-lg <?php echo e(request()->routeIs('dashboard') ? 'bg-sentry-purple/10 text-sentry-light border-l-2 border-sentry-purple' : 'hover:bg-sentry-deep text-sentry-muted hover:text-sentry-light'); ?> transition-all">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="sentry-card p-8 border-sentry-pink/30 group">
                        <div class="space-y-4">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->recentOrders->isEmpty()): ?>
                                <p class="text-sentry-light opacity-60 text-sm italic">No recent order history found in your dossier.</p>
                            <?php else: ?>
                                <div class="space-y-3 pt-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $this->recentOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</div><?php /**PATH /srv/http/laravel-riftbound-exam/resources/views/livewire/pages/dashboard.blade.php ENDPATH**/ ?>